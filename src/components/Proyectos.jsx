...
const originalCards = [
  {
    ...
    id: 1,
    description:
      "Listado dinámico colecciones de productos | Conexión store Vuex para obtener los datos de las colecciones | Evento que selecciona la colección y redirige al usuario a la página del producto seleccionado",
  },
  {
    url: bubba2,
    title: "Bubba Bags",
    id: 2,
    description:
      "Selección de un producto de la colección | Selección de colores disponibles | Visualización del producto en 3D | Conexión al store Vuex para obtener datos sobre la colección y productos",
  },
  {
    url: bubba3,
    title: "Bubba Bags",
    id: 3,
    description:
      "Formulario interactivo | Obtención de datos a través de Firebase ",
  },
  {
    url: ce1,
    ...
    id: 4,
    description:
      "Creado con Vue + Inertia + Laravel | Manejo de formularios de inicio de sesión y registro | Conexión de formularios con Laravel | Autenticación de usuarios | Manejo entre páginas con Inertia",
  },
  {
    url: ce2,
    title: "CIRCULAR ECONOMY",
    id: 5,
    description:
      "Acceso a diferentes secciones del evento en línea | Componente streaming principal | Acceso a otras salas de streaming",
  },
  {
    url: sbux1,
    title: "STARBUCKS",
  ...
  },
  {
    ...
    id: 8,
    description:
      "Experiencia interactiva | Inmersión 3D a través de la implementación del software Spline",
  },
  {
    url: sbuxx1,
    title: "STARBUCKS",
    id: 9,
    description:
      "Formulario de inicio de sesión y registro conectado con Laravel",
  },
  {
    url: sbuxx2,
    title: "STARBUCKS",
    id: 10,
    description:
      "Inmersión 3D a través de la implementación del software Spline",
  },
  {
    url: ong,
    title: "ONG",
...
export const Proyectos = () => {
  ...
  const gap = 4;
  const totalWidth =
    originalCards.length * (cardWidth + gap) - window.innerWidth;
